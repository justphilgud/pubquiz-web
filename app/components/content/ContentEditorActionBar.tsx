...
export default function ContentEditorActionBar({ onCancel, onSaveDraft, onPublish, pending = false, draftLabel = "Entwurf speichern", publishLabel = "Speichern und freigeben", message }: {
  onCancel?: () => void;
  onSaveDraft?: () => void;
  onPublish?: () => void;
  pending?: boolean;
  ...
  return <div className="fixed inset-x-0 bottom-0 z-40 border-t border-slate-200 bg-white/95 p-3 pb-[calc(0.75rem+env(safe-area-inset-bottom))] backdrop-blur">
    <div className="mx-auto max-w-4xl">{message}<div className="grid gap-2 sm:grid-cols-3">
