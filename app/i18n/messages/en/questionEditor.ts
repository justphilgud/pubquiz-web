...
export const enQuestionEditorMessages = {
  ...
  templates: {
    ...
    memeCaption: { name: "What the Meme!", description: "Teams add a top and bottom caption to a supplied image.", defaultQuestion: "Caption this image as a meme." },
  },
  management: {
  ...
  quality: {
    ...
    GENERATOR_OUTPUT_MISSING: "A successful generator run has no output", GENERATOR_LEGACY_OUTPUT: "Legacy output without a generator run", GENERATOR_CONFLICT: "Generator data is conflicting", PIXEL_STAGE_DURATIONS_INVALID: "Each pixel stage duration must be between 1 and 120 seconds", MEME_CAPTION_LAYOUT_INVALID: "The caption layout needs one to four valid zones with a unique order.", ESTIMATE_UNIT_REQUIRED: "Please enter a unit for the estimate question.", GOOGLE_PLACE_AVERAGE_RATING_INVALID: "The average rating must be between 0 and 5.", GOOGLE_PLACE_REVIEW_COUNT_INVALID: "The review count must be a non-negative integer.",
