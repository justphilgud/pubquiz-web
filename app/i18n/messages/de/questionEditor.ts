export const deQuestionEditorMessages = {
  ...
  templates: {
    ...
    memeCaption: { name: "What the Meme!", description: "Teams beschriften ein vorgegebenes Bild mit oberem und unterem Memetext.", defaultQuestion: "Beschriftet dieses Bild als Meme." },
  },
