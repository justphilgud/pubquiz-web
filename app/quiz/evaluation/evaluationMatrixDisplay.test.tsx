...
const matrix: EvaluationMatrix = {
  questions: [
    { id: 11, number: 1, text: "Eine bewusst sehr lange Frage, die den kompakten Tabellenkopf nicht verbreitern darf", sectionTitle: "Runde 1", maximumPointsLabel: "max. 1 Punkt", answered: 1, correct: 1, wrong: 0, partial: 0, reviewRequired: 0, unanswered: 0, successRate: 100, averagePoints: 1 },
    { id: 12, number: 2, text: "Teilantwort", sectionTitle: "Runde 1", maximumPointsLabel: "max. 2 Punkte", answered: 1, correct: 0, wrong: 0, partial: 1, reviewRequired: 0, unanswered: 0, successRate: 0, averagePoints: 1 },
    { id: 13, number: 3, text: "Manuell prüfen", sectionTitle: "Runde 2", maximumPointsLabel: "max. 1 Punkt", answered: 1, correct: 0, wrong: 0, partial: 0, reviewRequired: 1, unanswered: 0, successRate: 0, averagePoints: 0 },
  ],
  teams: [{
...
test("maps every evaluation status to a compact symbol and accessible label", () => {
  assert.deepEqual(
    ...
    { CORRECT: ["✓", "Richtig"], WRONG: ["×", "Falsch"], PARTIAL: ["½", "Teilweise"], REVIEW_REQUIRED: ["?", "Prüfen"], UNANSWERED: ["–", "Nicht beantwortet"] },
  );
});
