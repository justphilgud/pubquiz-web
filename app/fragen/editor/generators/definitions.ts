...
export const generatorDefinitions = [
  ...
  { id: "text_to_speech", version: 1, active: false, labelKey: "reserved", descriptionKey: "reserved", parameterKind: "NONE", inputSlots: [], outputSlots: ["lyrics_tts_audio"], supportedTemplates: ["standard"], executionMode: "ASYNCHRONOUS" },
