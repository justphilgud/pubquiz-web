...
export function EditorSaveActions({ capabilities, pendingAction, message, showDraftActions = true, workflowIdleLabel, onCancel, onSaveDraft, onRunWorkflow, onRequestChanges }: {
