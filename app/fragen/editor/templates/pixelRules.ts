export function pixelRules(mode: "CHALLENGE" | "STAGED") {
  return mode === "STAGED" ? {
    ...
    lines: ["Stufe 3 und 2: je 20 Sekunden · Stufe 1: offen bis zum Abschluss durch Moderation", "Stufe 3: 3 Punkte · Stufe 2: 2 Punkte · Stufe 1: 1 Punkt", "Antwort eingeben und bei Bedarf ändern.", "Später geändert? Die spätere Stufe zählt. Nur die letzte Antwort wird gewertet."],
  } : {
