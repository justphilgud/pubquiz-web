...
function StyleSilhouette({ style, swatches }: { style: PresentationDesignStyle; swatches: readonly string[] }) {
  if (style === "KOMM_ONE") return <div data-style-silhouette="KOMM_ONE" className="relative h-16 overflow-hidden border p-2" style={{ borderColor: swatches[1], backgroundColor: swatches[0] }}><span className="absolute -bottom-7 right-5 h-24 w-7 -rotate-[28deg]" style={{ backgroundColor: swatches[1] }} /><span className="absolute -bottom-5 right-11 h-24 w-3 -rotate-[28deg]" style={{ backgroundColor: swatches[2] }} /><span className="absolute bottom-3 left-3 h-2 w-2/5 bg-white" /></div>;
