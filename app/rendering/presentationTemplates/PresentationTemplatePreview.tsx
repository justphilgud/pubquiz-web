...
export const presentationPreviewRegistry = [
  ...
  { id: "YEARLY_STANDINGS", label: "Jahreswertung", group: "QUIZ_SLIDES", renderer: "FLOW", purpose: "Produktive Jahreswertung mit Rangbewegung", uniqueVisualState: true, flowType: "YEARLY_STANDINGS" },
...
function buildPreviewFlowConfig(type: QuizFlowItemType): QuizFlowConfig {
  ...
  if (type === "YEARLY_STANDINGS") return {
    ...base,
    title: "Jahreswertung",
    standingsSize: "ALL",
    showPoints: true,
...
const displayState: PresentationSlideDisplayState = {
  ...
  yearlyStandings: [
    ...
    { teamId: 3, teamname: "Vier gewinnt", punkte: 74, place: 3, previousPlace: 3, trend: "SAME", avatarCode: "tischlampe", photoUrl: null },
    { teamId: 4, teamname: "Besserwisser", punkte: 68, place: 4, previousPlace: null, trend: "SAME", avatarCode: "gummistiefel", photoUrl: null },
    { teamId: 5, teamname: "Die Schlauberger", punkte: 64, place: 5, previousPlace: 7, trend: "UP", avatarCode: "toaster", photoUrl: null },
    { teamId: 6, teamname: "Ratefüchse", punkte: 60, place: 6, previousPlace: 5, trend: "DOWN", avatarCode: "giesskanne", photoUrl: null },
    { teamId: 7, teamname: "Halbwissen", punkte: 57, place: 7, previousPlace: 7, trend: "SAME", avatarCode: "staubsauger", photoUrl: null },
    { teamId: 8, teamname: "Kopfnüsse", punkte: 53, place: 8, previousPlace: 9, trend: "UP", avatarCode: "schneebesen", photoUrl: null },
    { teamId: 9, teamname: "Die Ahnungslosen", punkte: 49, place: 9, previousPlace: 8, trend: "DOWN", avatarCode: "thermoskanne", photoUrl: null },
    { teamId: 10, teamname: "Quizkönige", punkte: 44, place: 10, previousPlace: 10, trend: "SAME", avatarCode: "buegeleisen", photoUrl: null },
    { teamId: 11, teamname: "Tisch 7", punkte: 39, place: 11, previousPlace: null, trend: "SAME", avatarCode: "teekanne", photoUrl: null },
    { teamId: 12, teamname: "Spätzünder", punkte: 34, place: 12, previousPlace: 11, trend: "DOWN", avatarCode: "wecker", photoUrl: null },
  ],
